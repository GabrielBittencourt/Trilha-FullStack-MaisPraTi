...
const IPAddressFinder = lazy(() => import('./components/IPAddressFinder'));
const MovieSearchEngine = lazy(() => import('./components/MovieSearchEngine'));
const TodoApp = lazy(() => import('./components/Todo/TodoApp'));
const QuizApp = lazy(() => import('./components/QuizApp'));
const LanguageTranslator = lazy(() => import('./components/LanguageTranslator'));
